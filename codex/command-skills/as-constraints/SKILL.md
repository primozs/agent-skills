...
Codex entry point for the agent-skills lifecycle. Invoke as `$as-constraints`.
...
1. Invoke and fully follow the `constraint-driven-development` skill from the agent-skills plugin (`$constraint-driven-development`).
