...
echo ""
echo "Commands available: /as-spec /as-plan /as-constraints /as-build /as-build-auto-loop /as-test /as-review /as-code-simplify /as-ship /as-webperf /as-ponytail-audit"
